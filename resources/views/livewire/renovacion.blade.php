<div class="min-h-screen p-8 bg-gray-100 dark:bg-gray-900">
    ...
    <div class="mx-auto max-w-7xl">
        <h1 class="mb-8 text-3xl font-bold text-gray-900 dark:text-gray-100">Renovaciones</h1>

        <div class="mb-8 overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
